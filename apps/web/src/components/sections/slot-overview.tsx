    ...
    <Card className={cn(className)}>
      <CardHeader className='flex flex-col gap-4'>
        ...
        <div className='flex items-center gap-4'>
          ...
          <div className='grid gap-1'>
            ...
            <div className='text-sm text-muted-foreground'>Steam ID: {statsVm.steam_id}</div>
          </div>
        </div>
      ...
      <CardContent className='grid gap-4 p-6'>
        <div className='grid grid-cols-2 gap-4'>
          <div className='grid gap-1'>
            <div className='text-xs font-medium text-muted-foreground'>Vigor</div>
            <div className='text-lg font-medium'>{statsVm.stats.vigor}</div>
          </div>
          <div className='grid gap-1'>
            <div className='text-xs font-medium text-muted-foreground'>Mind</div>
            <div className='text-lg font-medium'>{statsVm.stats.mind}</div>
          </div>
          <div className='grid gap-1'>
            <div className='text-xs font-medium text-muted-foreground'>Endurance</div>
          ...
          <div className='grid gap-1'>
            <div className='text-xs font-medium text-muted-foreground'>Dexterity</div>
            <div className='text-lg font-medium'>{statsVm.stats.dexterity}</div>
          </div>
          <div className='grid gap-1'>
            <div className='text-xs font-medium text-muted-foreground'>Intelligence</div>
            <div className='text-lg font-medium'>{statsVm.stats.intelligence}</div>
          </div>
          <div className='grid gap-1'>
            <div className='text-xs font-medium text-muted-foreground'>Faith</div>
            <div className='text-lg font-medium'>{statsVm.stats.faith}</div>
          </div>
          <div className='grid gap-1'>
            <div className='text-xs font-medium text-muted-foreground'>Arcane</div>
        ...
        <div className='grid grid-cols-2 gap-4'>
          ...
          <div className='grid gap-1'>
            <div className='text-xs font-medium text-muted-foreground'>Souls</div>
            <div className='text-lg font-medium'>{statsVm.stats.souls.toLocaleString()}</div>
          </div>
          <div className='grid gap-1'>
